...
test/%.exe: rvcc test/%.c
	...
	/home/name/riscv/bin/riscv64-unknown-linux-gnu-gcc -o- -E -P -C test/$*.c | ./rvcc -o test/$*.s -
	# $(CC) -static -o $@ test/$*.s -xc test/common
	/home/name/riscv/bin/riscv64-unknown-linux-gnu-gcc -static -o $@ test/$*.s -xc test/common

test: $(TESTS)
	# for i in $^; do echo $$i; ./$$i || exit 1; echo; done
	for i in $^; do echo $$i; /home/name/riscv/bin/qemu-riscv64 -L /home/name/riscv/sysroot ./$$i || exit 1; echo; done
